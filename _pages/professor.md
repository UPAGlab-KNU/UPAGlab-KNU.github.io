...
<div class="row">
  <div class="col-sm-4">
    <img src="{{ '/assets/img/prof_pic.jpg' | relative_url }}" alt="조대헌 교수님" style="width:100%; border-radius: 8px;">
  ...
  <div class="col-sm-8">
    ...
    <h3>연구 관심 분야 (Research Interests)</h3>
    <ul>
      <li>지리정보시스템 (GIS)</li>
      <li>공간통계 및 공간분석 (Spatial Statistics & Analysis)</li>
      <li>도시 모델링 (Urban Modeling)</li>
      <li>도시지리, 인구지리, 경제지리 (Urban / Population / Economic Geography)</li>
      <li>공간적 접근성 (Spatial Accessibility)</li>
    ...
    <h3>주요 연구 실적 (Major Research Achievements)</h3>
    <ul>
      <li>한국의 도시 축소 인구 요인 및 특성 분석</li>
      <li>코로나19 대응 시기 서울 지역 인구 이동성이 지역 상권 매출에 미친 영향의 시공간적 변동성</li>
      <li>한국 소지역 인구 추계 방법의 비교 분석</li>
      <li>한국 도시 축소의 공간적 특성 분석 — 인구 밀집 지역 변화를 중심으로</li>
      <li>한국 소지역 초·중·고 학생 수 추계 방법의 비교 분석 — 대구·경북 사례</li>
      <li>한국 대학의 입시 경쟁률 및 정원 충원율 관련 요인의 공간적 분석</li>
    </ul>
  </div>
</div>
